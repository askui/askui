...
2 - Write your tests with jasmine. Please note, that you have to use alias_name that you defined in step 1 for the uiControlServerUrl : `http://<alias_name>:6769`
