...
<iframe
  id="figure-1"
  src="/annotations/selecting_ui_elements.html"
  width="100%"
  height="450px"
></iframe>
...
The askui library provides the following visual relation selectors: `nearestTo()`, `above()`, `below()`, `rightOf()`, `leftOf()`, `contains()`and `in()`.

To fill out the form, the `nearestTo()` relation should be used by default:
...
<iframe
  src="/annotations/not_detected_element.html"
  width="100%"
  height="500"
></iframe>
...
<br />
In these cases and cases where elements are not detected at all, custom elements
