...
export class CreateExampleProject {
  ...
  private static async installTestFrameworkPackages(): Promise<void> {
    ...
    const frameworkDependencies = {
      jest: 'npm i -D @askui/askui-reporters typescript ts-node @types/jest@30.0.0 ts-jest@29.4.0 jest@29.7.0 allure-jest@3.3.0 allure-js-commons@3.3.0 eslint @typescript-eslint/parser @typescript-eslint/eslint-plugin eslint-plugin-import @askui/eslint-plugin-askui hpagent',
    };
